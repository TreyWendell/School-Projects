...
// Output: time taken to run sorting algorithm
   public static void main(String[] args) {
      ...
      else
      {
         ...
         if(!(arrayType.equals("r") || arrayType.equals("s") ||
         arrayType.equals("c"))){
            System.out.println("Invalid Array Type. Using default random array of length " + n);
            arrayType = "r";
         }
         if(!(algo.equals("q") || algo.equals("i") || algo.equals("s") ||
         algo.equals("m"))){
            System.out.println("Invalid Sorting Algorithm. Using default QuickSort");
            algo = "q";
         }
         if(n<=0){
